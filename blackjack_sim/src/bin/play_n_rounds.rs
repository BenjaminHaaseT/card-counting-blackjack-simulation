...
//     self, BasicStrategy, BettingStrategy, CountingStrategy, DecisionStrategy, HiLo,
//     MarginBettingStrategy, Strategy, TableState,
// };
...
//     let hilo = <Hilo as CountingStrategy>::new(6, MIN_BET, betting_strategy, decision_strategy);
